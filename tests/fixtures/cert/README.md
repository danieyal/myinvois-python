...
For real MyInvois signing, supply your own certificate from an approved
Malaysian CA (LHDN does not issue them) through `myinvois.config.CertConfig` —
never import from this directory.
